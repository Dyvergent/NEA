...
def main():
    ...
    running = True
    base_path = Path(__file__).parent / "solve_it_images"
    img_arr = {
        ...
        3:pygame.image.load(base_path / "tutorial3.png"),
        4:pygame.image.load(base_path / "tutorial4.png"),
        5:pygame.image.load(base_path / "tutorial5.png"),
        6:pygame.image.load(base_path / "tutorial6.png"),
        }
    current_screen = 0
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if next_button.handle_click(mouse_pos):
                        current_screen += 1
                        if current_screen >= 6: current_screen = 6
