# Sliding Puzzle Game (NEA Project)

A semi-fully-featured **Sliding Puzzle Game** developed using **Python** and **Pygame** as part of an A-Level Computer Science NEA (Non-Exam Assessment).
